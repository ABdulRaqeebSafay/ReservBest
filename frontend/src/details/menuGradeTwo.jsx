...
const MenuGradeTwo = ({ hotel_name }) => {
  const [menuGradeTwo, setMenuGradeTwo] = useState();
  ...
  useEffect(() => {
    axios.get(`${baseUrl}/hotels/${hotel_name}/getMenuGradeTwo`)
      .then((response) => {
        setMenuGradeTwo(response.data);
